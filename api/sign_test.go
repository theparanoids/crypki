...
func (mbcs *mockBadCertSign) SignX509Cert(ctx context.Context, cert *x509.Certificate, keyIdentifier string, priority proto.Priority, reqChan chan interface{}) ([]byte, error) {
	return nil, errors.New("bad message")
}
...
func (mgcs *mockGoodCertSign) SignX509Cert(ctx context.Context, cert *x509.Certificate, keyIdentifier string, priority proto.Priority, reqChan chan interface{}) ([]byte, error) {
