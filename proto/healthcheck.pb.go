...
type HealthCheckResponse struct {
	...
	Status HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=v3.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
}
...
var file_healthcheck_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x02, 0x76, 0x33, 0x22, 0x2e, 0x0a, 0x12, 0x48, 0x65, 0x61, 0x6c, 0x74,
	...
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0xa5, 0x01, 0x0a, 0x13, 0x48, 0x65, 0x61, 0x6c,
	...
	0x25, 0x2e, 0x76, 0x33, 0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b,
	...
	,
...
var file_healthcheck_proto_goTypes = []any{
	(HealthCheckResponse_ServingStatus)(0), // 0: v3.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: v3.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: v3.HealthCheckResponse
}
var file_healthcheck_proto_depIdxs = []int32{
	0, // 0: v3.HealthCheckResponse.status:type_name -> v3.HealthCheckResponse.ServingStatus
	1, // 1: v3.Health.Check:input_type -> v3.HealthCheckRequest
	1, // 2: v3.Health.Watch:input_type -> v3.HealthCheckRequest
	2, // 3: v3.Health.Check:output_type -> v3.HealthCheckResponse
	2, // 4: v3.Health.Watch:output_type -> v3.HealthCheckResponse
...
func file_healthcheck_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_healthcheck_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_healthcheck_proto_msgTypes[1].Exporter = func(v any, i int) any {
